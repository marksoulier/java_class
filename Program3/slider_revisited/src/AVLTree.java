...
public class AVLTree<AnyType extends Comparable<? super AnyType>>
{
    ...
    /**
     * Delete the min given the root
     * @param root
     * @return AVL Node
     */
    public AvlNode<AnyType> deleteMin(AvlNode<AnyType> root) {
    ...
    /**
    * go down left side to last node and delete it and return it
    *
     */
   private AvlNode<AnyType> deleteMin( AvlNode<AnyType> curr, AvlNode<AnyType> prev )
    {
        if( curr == null )
            return curr;
        ...
        return deleteMin( curr.left, curr );
    }
